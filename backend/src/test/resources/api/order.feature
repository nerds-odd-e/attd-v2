...
功能: 订单
  ...
  场景: 订单自动完成
    假如存在如下订单:
      ...
      | SN001 | 状态和时间都符合    | 19999 | 张三            | 13085901735     | 上海市长宁区           | delivering | 2000-05-10 20:00:00 |
#      | SN002 | 状态不符的时间符合     | 29999 | 李四            | 13817817777     | 上海市杨浦区           | toBeDelivered | 2000-05-10T20:00:00Z |
#      | SN003 | 状态符合时间不符合         | 39999 | 王五            | 13355557777     | 上海市浦东新区           | delivering | 2000-05-10T20:00:01Z |
    并且当前时间为"2000-05-25T20:00:00Z"
    当订单任务运行时
    那么订单"SN001"的状态为"done"
